...
export default function Rules() {
    return (
        <section id="rules" className="py-24 relative bg-zinc-50 dark:bg-black/80 transition-colors duration-300">
            <div className="max-w-6xl mx-auto px-6">
                ...
                >
                    ...
                    <p className="text-zinc-600 dark:text-zinc-400">Правила созданы, чтобы их не нарушать.</p>
                </motion.div>
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-start">
                    ...
                    <div className="flex-1 space-y-8 w-full">
                        ...
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-zinc-200 dark:border-white/10 shadow-lg dark:shadow-none"
                        >
                            <div className="flex items-center gap-3 mb-4">
                                <Shield className="text-primary w-6 h-6" />
                                <h3 className="text-xl font-bold text-zinc-900 dark:text-white">Правила Roblox Trade Чата</h3>
                            </div>
                        ...
                        >
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="text-xl font-bold text-zinc-900 dark:text-white">АДМИНИСТРАЦИЯ</h3>
                            </div>
                            <ul className="space-y-3 text-zinc-700 dark:text-zinc-300">
                        ...
                        >
                            ...
                            <p className="text-zinc-700 dark:text-zinc-300">📩 Пингуй <span className="text-primary font-mono">@admin</span></p>
                        </motion.div>
